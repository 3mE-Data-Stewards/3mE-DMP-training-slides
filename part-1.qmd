...
subtitle:  |
  ...
  *Slides are available at <span style="color: orange;">https://doi.org/10.5281/zenodo.7298877</span>*
...
![](img/research-lifecycle.png){fig-align="center"}

## Research data lifecycle

![](img/planning.png){fig-align="center"}

## Research data lifecycle

![](img/collecting.png){fig-align="center"}

## Research data lifecycle

![](img/publishing.png){fig-align="center"}
...
## Backup types {#data-backup-types .center}
...
![[Phoenix Nap](https://phoenixnap.it/kb/full-vs-incremental-vs-differential-backup)](/img/full-backup-illustration.png)
...
![[Phoenix Nap](https://phoenixnap.it/kb/full-vs-incremental-vs-differential-backup)](/img/incremental-backup.png)
...
![](img/data-organisation.png)

[from DATACC](data.4tu.nl/info/en/use/publish-cite/upload-your-data-in-our-data-repository/licencing){style="font-size: x-small;"}
...
![](img/r-notebook-quarto.png){.absolute width="500px" top="180"} ![](img/hello-knitr.png){.absolute width="250px" top="300" left="248" style="border: 1px solid black;"}

![](img/python-notebook-quarto.png){.absolute width="500px" top="0" right="0"} ![](img/hello-jupyter.png){.absolute width="250px" top="190" right="0" style="border: 1px solid black;"}
...
:::
```{r}
#quarto::quarto_render("part-1.qmd")
```

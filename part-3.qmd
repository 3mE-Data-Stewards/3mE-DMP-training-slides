...
- [Apply what you learned to your daily workflow]{style="opacity: 0.3;"}
- [Complete the DMP in collaboration with supervisor (and Data Steward, if needed)]{style="opacity: 0.3;"}
...
- GitHub/Lab (but can be connected to 4TU and Zenodo)
